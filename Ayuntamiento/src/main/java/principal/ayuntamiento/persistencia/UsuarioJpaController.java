...
public class UsuarioJpaController implements Serializable {
    ...
    /**
     * Función que me trae todos los usuarios de mi base de datos
     * @return lista de usuarios sin borrar
     */
    public List<Usuario> encontrarUsuariosNoBorrados() {
        EntityManager em = getEntityManager();
        try {
            TypedQuery<Usuario> query = em.createQuery(
                    "SELECT u FROM Usuario u WHERE u.borrado = :borrado", Usuario.class);
